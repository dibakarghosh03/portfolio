...
export const HeroSection = () => {
  return (
    <div className="py-32 md:py-36 lg:py-52 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={720} rotation={-30}>
          <div className="size-4 rounded-full bg-emerald-300/30"></div>
        </HeroOrbit>
        <HeroOrbit size={720} rotation={-30}>
          <div className="size-4 rounded-full bg-emerald-300/30"></div>
        </HeroOrbit>
        <HeroOrbit size={600} rotation={130}>
          <div className="size-3 rounded-full bg-emerald-300/20"></div>
        </HeroOrbit>
        <HeroOrbit size={820} rotation={100}>
          <div className="size-3 rounded-full bg-emerald-300/20"></div>
        </HeroOrbit>
      </div>
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4 ">
          ...
          <button className="inline-flex items-center gap-x-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl">
